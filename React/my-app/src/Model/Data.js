...
const Meat = [
    ...
    {id: 3, image:steak, title: 'Beefsteak', price: 50},
    {id: 4, image:spaghetti, title: 'Spaghetti', price: 25},
]
const SeaFood = [
    {id: 5, image:risotto, title: 'Risotto', price: 45},
    {id: 6, image:salmon, title: 'Salmon', price: 35},
    {id: 7, image:sashimi, title: 'Sashimi', price: 55},
    {id: 8, image:squid, title: 'Squid Fried', price: 30},
]
const Dessert = [
    {id: 9, image:chocolate, title: 'Chocolate Pie', price: 20},
    {id: 10, image:icecream, title: 'Ice Cream', price: 24},
    {id: 11, image:parfait, title: 'Parfait', price: 30},
    {id: 12, image:kiwi, title: 'Kiwi Pie', price: 32},
]
const Drink = [
    {id: 13, image:coca, title: 'Coca', price: 5},
    {id: 14, image:juice, title: 'Juice', price: 15},
]
